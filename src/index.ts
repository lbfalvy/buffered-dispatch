export type Call<T extends any[], U> = {
    resolve: (u: U | PromiseLike<U>) => void
    reject: (e: any) => void
    args: T
}

export type CallOf<T extends (...args: any[]) => Promise<any>> =
...
export const wrap = <T extends any[], U>(
...
export function bufferedDispatch<T extends any[], U>(): [
    (...args: T) => Promise<U>,
    () => Promise<Call<T, U>>
] {
